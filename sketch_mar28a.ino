...
if( EEPROM.read(0) == 1 ){
    ...
    if( EEPROM.read(0) == 3 ){
      strip.fill(strip.Color(128, 0, 200), 0, 28);
      strip.show();
    }

    if( EEPROM.read(0) == 4 ){
      strip.fill(strip.Color(0, 255, 255), 0, 28);
      strip.show();
    }

    if( EEPROM.read(0) == 5 ){
      strip.fill(0, 0, 28);
      strip.fill(strip.Color(55, 0, 0), 0, oliversBatteryLevel()*28);
      strip.show();
    }
